...
Be aware that the installation process may take a while if this is the first time to install
...
genlink <- function (li.pairs) {
    vapply(li.pairs, FUN.VALUE = character(1),
        function (pairs) {
            ...
            sprintf("[%s](https://marlin-na.github.io/TnT/examples/%s)", name, base.link)
        }
    )
}
