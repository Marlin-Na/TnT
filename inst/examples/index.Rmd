...
then constructing tnt board from a list of tracks.
...
#### [TnT Board and TnT Genome](tntboard.html)

Given a list of tracks, 

The page provided examples of how to construct a TnTBoard or TnTGenome and set
view range, coordinate range, etc. 
...
To construct a track, the first to

The following table shows available track types and their instances.
...
<tr>
<td class="col-md-2">
<strong> [Tx Track and FeatureGroup Track](tracktype-TxTrack.html) </strong>
</td>
<td class="col-md-9">
```{r, echo=FALSE}
suppressMessages({
