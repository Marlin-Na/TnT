...
### [View Range, Coordinate Limit and Allowed Zoom Range]()
...
TnTBoard(track, view.range = range(track), coord.range = ranges(range(track)))
```
...
## Track Manipulation (TODO)

### [Background, Height and Label (`trackSpec`)]()

### [Track Data (`trackData`)]()

### [Methods Passed to Track Data (`[`, `$`, `seqinfo`, `range`)]()
